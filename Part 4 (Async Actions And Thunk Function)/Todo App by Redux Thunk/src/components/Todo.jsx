...
import { colorSelected, deleteTodo, toggleTodo } from './../redux/todos/actions';
    ...
    return (
        <div className="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0" >
            ...
            <div
                ...
                onClick={() => changeColorHandler(id, 'green')}
            ></div>
            ...
            <div
                ...
                onClick={() => changeColorHandler(id, 'yellow')}
            ></div>
            ...
            <div
                ...
                onClick={() => changeColorHandler(id, 'red')}
            ></div>
